...
export const create = ({ bodymen: { body: { email, link } } }, res, next) =>
  User.findOne({ email })
    ...
    .then((reset) => {
      ...
      const content = `
        Hey, ${user.name}.<br><br>
        You requested a new password for your TODO List API account.<br>
        ...
        &mdash; TODO List API Team
      `
      return sendMail({ toEmail: email, subject: 'TODO List API - Password Reset', content })
    })
